...
import com.mysite.auth_service.model.request.LoginRequest;
...
public class AuthController {
    ...
    public String sendTestUnauthenticated() throws AuthApiException{
        this.simpleEmailService.sendEmail("grantmitchell@mysite.com", "First Email Subject", "<div><img src=\"https://avatars.githubusercontent.com/u/154090351?s=200&v=4\"><h2>Test Email Succeeds!</h2></div>");
	...
	public BasicResponse createAccount(@RequestBody(required = false) CreateAccountRequest accountRequest) throws AuthApiException, IOException, MessagingException, GeneralSecurityException {
		...
		if (existingUserByEmail != null){
			...
			simpleEmailService.sendEmail( accountRequest.getEmailAddress(),"Create Account","Click the link below to create your account. Once you click the link you will be redirected to mysite.com as a signed in user. Thank you for signing up with us today! \n \n https://accounts.mysite.com/verify-new-account?token="+accountJwtToken);
	...
	public ResponseEntity<Object> verifyAccount(@RequestBody String token) throws AuthApiException, URISyntaxException {
		...
		simpleEmailService.sendEmail(account.getEmailAddress(),"Welcome to MySite!","Thank you for joining us in our journey in a healthy world!");
